...
dojo-academy adopts these in its slide templates via DOJ-5601. If a consumer
template does not already ship these declarations, the generator adds them to the
`<style>` block of the deck it emits.
