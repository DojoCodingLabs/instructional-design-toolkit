...
(p. ej. `dojo-academy`), que se descubren y aplican en runtime sin tocar la base.
...
### Authoring de contenido (migrados de dojo-academy) → `content/`
...
- Output: `content/paths/<slug>/path-overview.md` (frontmatter alineado con el
  contrato de contenido de `dojo-academy`).
...
### `content/` — authoring de contenido (migrados de dojo-academy)
